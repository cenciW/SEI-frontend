...
export default function AdminPage() {
  ...
  const getModuleDisplayName = (modulePath: string) => {
    if (modulePath === 'knowledge_base.pl') return '📚 Base de Conhecimento Principal';
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-400 mt-2">Gerenciamento da Base de Conhecimento Prolog</p>
          </div>
          <Button 
        ...
        <Card className="bg-slate-900 border-slate-800 shadow-xl">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-slate-100 text-xl">Editor de Módulos Prolog</CardTitle>
          ...
          <CardContent className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-blue-400/80">
                    Edite as regras Prolog abaixo. Ao clicar em "Salvar e Validar", o sistema tentará
                    carregar as regras no motor Prolog. Se houver erros de sintaxe, as alterações serão rejeitadas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center pt-2">
              <div className="flex-1">
                {status && (
                  <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg animate-in fade-in slide-in-from-left-2 ${
                    status.includes('✅') 
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-300 mb-1">Sobre este módulo:</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                {selectedModule === 'knowledge_base.pl' 
                  ...
                  : `Módulo específico para a cultura ${getModuleDisplayName(selectedModule)}. Contém regras especializadas para esta planta.`
                }
              </p>
            </div>
          </div>
